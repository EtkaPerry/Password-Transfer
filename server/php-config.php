...
define('MAX_DATA_BYTES', envInt('PASSWORD_TRANSFER_MAX_DATA_BYTES', 10485760));
...
define('SESSION_VERIFY_TTL_SECONDS', envInt('PASSWORD_TRANSFER_SESSION_VERIFY_TTL_SECONDS', 300));

define('PASSWORD_TRANSFER_DATA_DIR', envString('PASSWORD_TRANSFER_DATA_DIR', ''));

define('TURNSTILE_SITE_KEY', envString('CF_TURNSTILE_SITE_KEY', 'your_turnstile_site_key'));
define('TURNSTILE_SECRET_KEY', envString('CF_TURNSTILE_SECRET_KEY', 'your_turnstile_secret_key'));
